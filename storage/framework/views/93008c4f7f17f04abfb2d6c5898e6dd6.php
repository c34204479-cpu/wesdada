        ...
        <div class="category-selection-inner">
            <div class="category-grid">
                ...
                <div class="category-dropdown-container">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?php echo e(route('products.apotek')); ?>?kategori_produk=SKINCARE+%26+KOSMETIK" class="dropdown-item">
                            <i class="fa-solid fa-th-large"></i>
                            <span>Skincare</span>
                        </a>
                        <a href="<?php echo e(route('products.apotek')); ?>?kategori_produk=SKINCARE+%26+KOSMETIK" class="dropdown-item">
...
<?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\components\category-selection.blade.php ENDPATH**/ ?>