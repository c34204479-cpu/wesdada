<?php $__env->startSection('title', 'Edit Promo Produk - Admin Sumberindo Farma Tama'); ?>
<?php $__env->startSection('page-title', '🏷️ Edit Promo Produk'); ?>
...
.new-preview { width:180px; height:180px; border-radius:0.75rem; border:2px dashed #fecaca; overflow:hidden; display:none; margin-top:0.5rem; }
...
<div style="margin-bottom:1.25rem;">
    <a href="<?php echo e(route('admin.promo-products.index')); ?>" style="color:#6b7280;text-decoration:none;font-size:0.85rem;">
...
<div class="form-card">
    ...
    <form action="<?php echo e(route('admin.promo-products.update', $promoProduct)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

        <div class="form-group">
            <label class="form-label">Judul Promo <span class="req">*</span></label>
            <input type="text" name="judul" class="form-control" value="<?php echo e(old('judul', $promoProduct->judul)); ?>" required>
        </div>

        <div class="form-group">
            <label class="form-label">Subjudul / Keterangan Singkat</label>
            <input type="text" name="subjudul" class="form-control" value="<?php echo e(old('subjudul', $promoProduct->subjudul)); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <div class="img-preview-wrap" id="currentWrap">
                <img src="<?php echo e(url('storage/'.$promoProduct->gambar)); ?>" alt="<?php echo e($promoProduct->judul); ?>" id="currentImg">
            </div>
        ...
        <div class="form-row">
            <div class="form-group" style="margin-bottom:0;">
                ...
                <input type="text" name="url_tujuan" class="form-control" value="<?php echo e(old('url_tujuan', $promoProduct->url_tujuan)); ?>" placeholder="/products atau https://...">
                <p class="form-hint">Link ketika foto diklik</p>
            </div>
            <div class="form-group" style="margin-bottom:0;">
                <label class="form-label">Label Tombol</label>
                <input type="text" name="label_tombol" class="form-control" value="<?php echo e(old('label_tombol', $promoProduct->label_tombol)); ?>">
            </div>
        </div>
        ...
        <div class="form-row" style="margin-top:1.25rem;">
            <div class="form-group" style="margin-bottom:0;">
                ...
                <input type="number" name="urutan" class="form-control" min="0" value="<?php echo e(old('urutan', $promoProduct->urutan)); ?>">
            ...
            <div class="form-group" style="margin-bottom:0;">
                ...
                <div class="toggle-wrap">
                    <label class="toggle-switch">
                        <input type="checkbox" name="aktif" value="1" <?php echo e($promoProduct->aktif ? 'checked' : ''); ?>>
        ...
        <div class="btn-actions">
            ...
            <a href="<?php echo e(route('admin.promo-products.index')); ?>" class="btn-back"><i class="fa-solid fa-xmark"></i> Batal</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\admin\promo_products\edit.blade.php ENDPATH**/ ?>