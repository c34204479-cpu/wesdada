<?php $__env->startSection('title', 'Manajemen Obat - Admin Apotek Medistra Farma'); ?>
    ...
    <form method="GET" action="<?php echo e(route('admin.medicines.index')); ?>">
        <div class="search-row">
                ...
                <div class="search-input-wrap">
                    <select name="kategori_produk">
                        ...
                        <?php $__currentLoopData = $kategoriOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kat); ?>" <?php echo e(($kategori_produk ?? '') === $kat ? 'selected' : ''); ?>>
                                <?php echo e(\App\Models\ProductCategory::iconFor($kat)); ?> <?php echo e($kat); ?>
            ...
            <div class="search-actions">
                ...
                <?php if($search || $kategori || $brand || ($kategori_produk ?? false)): ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php elseif($medicine->kelompok === 'APOTEK'): ?>
                    ...
                    <td>
                        <div style="display:flex;flex-direction:column;gap:0.25rem;">
                            <input type="number"
                               ...
                               data-update-url="<?php echo e(route('admin.medicines.update-price', $medicine->id)); ?>"
                    ...
                    <td>
                        <div style="display:flex;flex-direction:column;gap:0.25rem;">
                            <input type="number"
                                   ...
                                   data-update-url="<?php echo e(route('admin.medicines.update-stock', $medicine->id)); ?>"
                    ...
                    <td>
                        <div class="action-wrap">
                            <a href="<?php echo e(route('admin.medicines.edit', ['medicine' => $medicine->id, 'search' => $search, 'kategori' => $kategori, 'tipe' => $tipe, 'page' => request('page')])); ?>" class="btn-edit">
                                <i class="fa-solid fa-pen"></i> Edit
                            </a>
                            <form action="<?php echo e(route('admin.medicines.destroy', ['medicine' => $medicine->id, 'search' => $search, 'kategori' => $kategori, 'tipe' => $tipe, 'page' => request('page')])); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\admin\medicines\index.blade.php ENDPATH**/ ?>