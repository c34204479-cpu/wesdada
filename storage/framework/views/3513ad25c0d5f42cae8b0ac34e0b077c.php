<?php $__env->startSection('title', 'Farmakologi - Sumberindo Farma Tama'); ?>
    ...
    <div class="container">
        ...
        <div class="farma-stats">
            <div class="farma-stat-card">
                <span class="num"><?php echo e(count($diseases)); ?></span>
                <span class="lbl">Jenis Penyakit</span>
            </div>
            <div class="farma-stat-card">
                <span class="num"><?php echo e(collect($diseases)->sum(fn($d) => count($d['symptoms']))); ?></span>
        ...
        <div class="farma-layout">
            ...
            <aside class="farma-sidebar">
                ...
                <div class="sidebar-list" id="sidebarList">
                    <?php $__currentLoopData = $diseases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $disease): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="sidebar-item" onclick="scrollToDisease(<?php echo e($i); ?>)" id="sidebar-<?php echo e($i); ?>">
            ...
            <div class="farma-content" id="diseaseList">
                <?php $__currentLoopData = $diseases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $disease): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="disease-card" id="disease-<?php echo e($i); ?>" data-name="<?php echo e(strtolower($disease['name'])); ?>">
                    <div class="disease-card-header" onclick="toggleCard(<?php echo e($i); ?>)">
                        <div class="disease-icon">
                            <i class="<?php echo e($disease['icon']); ?>"></i>
                        </div>
                        <div class="disease-title"><?php echo e($disease['name']); ?></div>
                        <div style="background:rgba(255,255,255,0.2);padding:0.2rem 0.6rem;border-radius:20px;font-size:0.75rem;color:white;margin-right:0.5rem;">
                            <?php echo e(count($disease['symptoms'])); ?> gejala
                        </div>
                    ...
                    <div class="disease-body">
                        ...
                        <?php $__currentLoopData = $disease['symptoms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $symptom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="symptom-row">
                            <div class="symptom-label">
                                <i class="fa-solid fa-chevron-right"></i>
                                <?php echo e($symptom['gejala']); ?>

                            </div>
                            <div class="komposisi-text"><?php echo e($symptom['komposisi']); ?></div>
                            <div>
                                <div class="obat-list" style="margin-bottom:0.4rem;">
                                    <?php $__currentLoopData = explode('/', $symptom['obat']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(trim($obat)): ?>
                                        <span class="obat-tag"><?php echo e(trim($obat)); ?></span>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <?php if($symptom['dosis']): ?>
                                <div class="dosis-badge">
                                    <i class="fa-solid fa-clock"></i>
                                    <?php echo e($symptom['dosis']); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\farmakologi.blade.php ENDPATH**/ ?>