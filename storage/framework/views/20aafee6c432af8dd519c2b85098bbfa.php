<?php $__env->startSection('title', 'Tambah Obat - Admin Sumberindo Farma Tama'); ?>
...
<div style="display:flex;align-items:center;gap:0.5rem;font-size:0.82rem;color:#9ca3af;margin-bottom:1.25rem;">
    <a href="<?php echo e(route('admin.medicines.index')); ?>" style="color:#B91C1C;text-decoration:none;font-weight:600;">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="kelompok" class="form-input <?php echo e($errors->has('kelompok') ? 'is-invalid' : ''); ?>">
                        <option value="">— Pilih Kelompok —</option>
                        <option value="PBF" <?php echo e(old('kelompok') == 'PBF' ? 'selected' : ''); ?>>PBF</option>
                        <option value="APOTEK" <?php echo e(old('kelompok') == 'APOTEK' ? 'selected' : ''); ?>>APOTEK</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" class="form-input <?php echo e($errors->has('harga') ? 'is-invalid' : ''); ?>" placeholder="5000" step="1" min="0" value="<?php echo e(old('harga')); ?>" required>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\admin\medicines\create.blade.php ENDPATH**/ ?>