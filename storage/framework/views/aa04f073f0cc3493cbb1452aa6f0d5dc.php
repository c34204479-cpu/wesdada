...
<head>
    ...
    ?>
    <meta property="og:image" content="<?php echo e(asset('logo_apotek_medistrafarma-removebg-preview copy.png')); ?>?v=20260901-2">
    <meta property="og:image:secure_url" content="<?php echo e(asset('logo_apotek_medistrafarma-removebg-preview copy.png')); ?>?v=20260901-2">
    <meta name="twitter:image" content="<?php echo e(asset('logo_apotek_medistrafarma-removebg-preview copy.png')); ?>?v=20260901-2">
    <title><?php echo $__env->yieldContent('title', 'Apotek Medistra Farma - Apotik Online'); ?></title>
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('favicon.ico')); ?>?v=<?php echo e($faviconV); ?>">
    <link rel="shortcut icon" href="<?php echo e(asset('favicon.ico')); ?>?v=<?php echo e($faviconV); ?>">
    ...
    <nav class="navbar">
        <div class="navbar-container">
            <a href="<?php echo e(route('login')); ?>" class="navbar-brand" title="Login Admin Apotek Medistra Farma">
                <img src="<?php echo e(asset('logo_apotek_medistrafarma-removebg-preview copy.png')); ?>" alt="Apotek Medistra Farma Logo">
            ...
            <div class="footer-content">
                <div>
                    <div style="display:flex; align-items:center; gap:0.75rem; margin-bottom:1rem;">
                        <img src="<?php echo e(asset('logo_apotek_medistrafarma-removebg-preview copy.png')); ?>" alt="Logo Apotek Medistra Farma" style="width:52px; height:52px; object-fit:contain; border-radius:12px; background:rgba(255,255,255,0.7); padding:0.35rem; box-shadow:0 8px 16px rgba(15,118,110,0.12);">
                    ...
                    <div class="footer-socials" aria-label="Ikuti Apotek Medistra Farma">
                        ...
                        <a href="https://www.tiktok.com/@apotek_medistrafarma" target="_blank" rel="noopener noreferrer" class="social-circle social-tiktok" aria-label="TikTok" title="TikTok"><img src="<?php echo e(asset('logo tiktok.avif')); ?>" alt="TikTok"></a>
                        <a href="https://shopee.co.id/" target="_blank" rel="noopener noreferrer" class="social-circle" aria-label="Shopee" title="Shopee" style="background:#ee3131;"><img src="<?php echo e(asset('logoshopee.jpeg')); ?>" alt="Shopee" style="width:20px;height:20px;object-fit:contain;border-radius:4px;"></a>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .float-links {
                ...
                overflow:visible; max-height:none; transition:none;
            ...
            .float-item { gap:0.35rem; flex-direction:row; align-items:center; }
            .float-label-mobile {
                background:#1f2937; color:white; font-size:0.68rem; font-weight:600;
                padding:0.2rem 0.5rem; border-radius:8px; white-space:nowrap;
                display:none;
            }
            .float-links.open .float-label-mobile { display:none; }
        }
    </style>
