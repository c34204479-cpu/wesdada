<?php $__env->startSection('title', 'Tambah Promo Produk - Admin Sumberindo Farma Tama'); ?>
<?php $__env->startSection('page-title', '🏷️ Tambah Promo Produk'); ?>
...
<div class="form-card">
    <?php if(isset($tableReady) && !$tableReady): ?>
    ...
    <form action="<?php echo e(route('admin.promo-products.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>

        <div class="form-group">
            <label class="form-label">Judul Promo <span class="req">*</span></label>
            <input type="text" name="judul" class="form-control" placeholder="Contoh: Promo Vitamin C Murah" value="<?php echo e(old('judul')); ?>" required>
        </div>

        <div class="form-group">
            <label class="form-label">Subjudul / Keterangan Singkat</label>
            <input type="text" name="subjudul" class="form-control" placeholder="Contoh: Diskon 30% minggu ini" value="<?php echo e(old('subjudul')); ?>">
        </div>
        ...
        <div class="form-row">
            <div class="form-group" style="margin-bottom:0;">
                ...
                <input type="text" name="url_tujuan" class="form-control" placeholder="/products atau https://..." value="<?php echo e(old('url_tujuan')); ?>">
                <p class="form-hint">Link ketika foto diklik</p>
            </div>
            <div class="form-group" style="margin-bottom:0;">
                <label class="form-label">Label Tombol</label>
                <input type="text" name="label_tombol" class="form-control" placeholder="Lihat Sekarang" value="<?php echo e(old('label_tombol', 'Lihat Sekarang')); ?>">
            </div>
        </div>
        ...
        <div class="form-row" style="margin-top:1.25rem;">
            <div class="form-group" style="margin-bottom:0;">
                ...
                <input type="number" name="urutan" class="form-control" placeholder="0" min="0" value="<?php echo e(old('urutan', 0)); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\admin\promo_products\create.blade.php ENDPATH**/ ?>