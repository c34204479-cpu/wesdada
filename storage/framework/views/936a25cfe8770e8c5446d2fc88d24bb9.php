...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Apotek Medistra Farma - Apotik Online Terpercaya'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('logo_apotek_medistrafarma-removebg-preview copy.png')); ?>" alt="Apotek Medistra Farma Logo" style="height: 30px; width: auto; margin-right: 0.5rem;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link <?php if(request()->routeIs('home')): ?> active <?php endif; ?>" href="<?php echo e(route('home')); ?>">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(request()->routeIs('about')): ?> active <?php endif; ?>" href="<?php echo e(route('about')); ?>">Tentang Kami</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(request()->routeIs('products.pbf')): ?> active <?php endif; ?>" href="<?php echo e(route('products.pbf')); ?>">Produk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(request()->routeIs('services')): ?> active <?php endif; ?>" href="<?php echo e(route('services')); ?>">Layanan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(request()->routeIs('contact')): ?> active <?php endif; ?>" href="<?php echo e(route('contact')); ?>">Kontak</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 footer-section">
                    <h5>Navigasi</h5>
                    <a href="<?php echo e(route('home')); ?>" class="footer-link">Beranda</a>
                    <a href="<?php echo e(route('about')); ?>" class="footer-link">Tentang Kami</a>
                    <a href="<?php echo e(route('products.pbf')); ?>" class="footer-link">Produk</a>
                    <a href="<?php echo e(route('services')); ?>" class="footer-link">Layanan</a>
                </div>
                    <div class="col-md-3 footer-section">
                    <h5>Hubungi Kami</h5>
                    <p class="footer-link">
...
<?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\layouts\app.blade.php ENDPATH**/ ?>