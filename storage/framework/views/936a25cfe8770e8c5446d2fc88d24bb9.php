...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sumberindo Farma Tama - Apotik Online Terpercaya'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('logo pt sumber indo farma tama.png')); ?>" alt="Sumberindo Farma Logo" style="height: 30px; width: auto; margin-right: 0.5rem;">
