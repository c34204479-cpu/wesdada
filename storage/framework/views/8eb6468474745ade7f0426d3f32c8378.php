<?php $__env->startSection('title', 'Beranda - Sumberindo Farma Tama'); ?>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6 hero-content">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('contact')); ?>" class="btn-hero-outline"><i class="fa-solid fa-handshake"></i> Jadi Mitra</a>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="distributor-gallery">
                    ...
                    <div class="main-photo">
                        <img src="<?php echo e(asset('page3.jpeg')); ?>" alt="Sumberindo Farma Tama - Distributor Obat Terpercaya">
                    ...
                    <div class="small-photos">
                        <div class="small-photo">
                            <img src="<?php echo e(asset('page3.jpeg')); ?>" alt="Gudang Obat">
                            <div class="small-overlay">
                                <span><i class="fas fa-warehouse"></i> Gudang</span>
                            </div>
                        </div>
                        <div class="small-photo">
                            <img src="<?php echo e(asset('page3.jpeg')); ?>" alt="Tim Farmasi">
                            <div class="small-overlay">
                                <span><i class="fas fa-user-md"></i> Tim Ahli</span>
                            </div>
                        </div>
                        <div class="small-photo">
                            <img src="<?php echo e(asset('page3.jpeg')); ?>" alt="Pengiriman">
                            <div class="small-overlay">
                                <span><i class="fas fa-truck"></i> Distribusi</span>
                            </div>
                        </div>
                        <div class="small-photo">
                            <img src="<?php echo e(asset('page3.jpeg')); ?>" alt="Kualitas Terjamin">
                            <div class="small-overlay">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\pages\home.blade.php ENDPATH**/ ?>