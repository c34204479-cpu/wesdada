<?php $__env->startSection('title', 'Tambah Berita - Admin Apotek Medistra Farma'); ?>
...
<div style="background: white; padding: 2rem; border-radius: 0.75rem; max-width: 900px;">
    <form action="<?php echo e(route('admin.news.store')); ?>" method="POST" enctype="multipart/form-data" id="newsForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="date" id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', now()->toDateString())); ?>" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.375rem; font-family: inherit;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 2rem; padding: 1rem; background: #f3f4f6; border-radius: 0.375rem;">
            <label style="display: flex; align-items: center; cursor: pointer;">
                <input type="checkbox" name="is_published" value="1" <?php echo e(old('is_published') ? 'checked' : ''); ?> style="width: 1rem; height: 1rem; margin-right: 0.5rem; cursor: pointer;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views/admin/news/create.blade.php ENDPATH**/ ?>