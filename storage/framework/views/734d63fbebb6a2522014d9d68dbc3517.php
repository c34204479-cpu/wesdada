...
<?php $__env->startSection('title', 'Kontak - Sumberindo Farma Tama'); ?>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="https://www.tiktok.com/@apotek_medistrafarma" target="_blank" rel="noopener noreferrer" class="btn btn-primary" style="border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; padding: 0; background: #000000; border: none;">
                            <div style="width:24px;height:24px;background:white;border-radius:6px;display:flex;align-items:center;justify-content:center;"><img src="<?php echo e(asset('logo tiktok.avif')); ?>" alt="TikTok" style="width:20px;height:20px;object-fit:contain;"></div>
                        </a>
                        <a href="#" class="btn btn-primary" style="border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; padding: 0; background: #EE3131; border: none;">
                            <div style="width:24px;height:24px;background:white;border-radius:6px;display:flex;align-items:center;justify-content:center;"><img src="<?php echo e(asset('logoshopee.jpeg')); ?>" alt="Shopee" style="width:20px;height:20px;object-fit:contain;"></div>
                        </a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medistrafarma\resources\views\pages\contact.blade.php ENDPATH**/ ?>