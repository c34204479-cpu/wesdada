    ...
    <div class="container">
        <div style="background:linear-gradient(135deg,#0f766e,#2563eb);color:white;padding:2rem;border-radius:18px;">
            <div style="display:flex;gap:1rem;align-items:center;">
                <img src="{{ asset('logo_apotek_medistrafarma-removebg-preview copy.png') }}" alt="Apotek Medistra Farma" style="height:84px;border-radius:12px;background:white;padding:0.5rem;" />
                <div>
