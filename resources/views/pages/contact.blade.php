                ...
                <div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="#" class="btn btn-primary" style="border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; padding: 0; background: #EE3131; border: none;">
                            <div style="width:24px;height:24px;background:white;border-radius:6px;display:flex;align-items:center;justify-content:center;"><img src="{{ asset('logoshopee.jpeg') }}" alt="Shopee" style="width:20px;height:20px;object-fit:contain;"></div>
                        </a>
                    </div>
                </div>
            </div>
